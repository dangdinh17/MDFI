...
class LDV2_TrainDataset(data.Dataset):
    """LDV2 dataset.
...
class LDV2_TestDataset(data.Dataset):
    ...
    def __init__(self, opts_dict, radius):
        ...
        # dataset paths
        self.gt_root = op.join('data/LDV2/', self.opts_dict['gt_path'])
        self.lq_root = op.join('data/LDV2/', self.opts_dict['lq_path'])
