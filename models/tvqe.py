...
import utils
from .TVQE.SUNet_detail_JVT import SUNet
from .TVQE.restormer_arch import TransformerBlock, RestormerQE
...
class TVQE(nn.Module):
    def __init__(self, opts_dict):
        super(TVQE, self).__init__()
...
if __name__ == '__main__':
    ...
    model = TVQE(opts_dict=opts_dict['network']).to(device)
