...
from .FEA import FEA
from .QE_HFERB1_RDB1_HFERB1_Relu import QE_HFERB_RDCAB
...
class HFERB(nn.Module):
    ...
    def forward(self, x): # n t h w
        short = self.first_fc(x) # n 64 h w
