...
weight_type = args.type
if weight_type == 0:
    ckp_path = f'exp/TGAF_QP{qp}/best_weight.pth'
elif weight_type == 1:
    ckp_path = f'checkpoint/TGAF_QP37.pt'
...
log_fp = open(f'log/log_test_TGAF_QP{qp}.txt', 'a')
...
def main():
    ...
    # for seqname in seqnames:
        ...
        #     msg = "Model TGAF Frame {:<2} psnr [{:.3f}] enh_psnr [{:.3f}] ssim [{:.5f}] enh_ssim [{:.5f}]".format(
