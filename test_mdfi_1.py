...
qp = 37
if weight_type == 0:
    ckp_path = 'exp/MDFI_1_QP37/best_weight.pth'
elif weight_type == 1:
...
def main():
    ...
    for seqname in seqnames:
        ...
        log_fp = open(f'log/log_test_MDFI_1_QP37.txt', 'a')
        ...
        for idx in range(nfs):
            ...
            msg = "Model MDFI Frame {:<2} psnr [{:.3f}] enh_psnr [{:.3f}] ssim [{:.5f}] enh_ssim [{:.5f}]".format(
